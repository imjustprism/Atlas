...
reg import "$fileSharingConfigPath\Network Navigation Pane\Disable Network Navigation Pane (default).reg" *> $null
reg import "$fileSharingConfigPath\Give Access To Menu\Disable Give Access To Menu (default).reg" *> $null
